            ...
            @if ($studentInfo->count() > 0)
                ...
                <div class="card mx-5 my-3">
                    <div class="card-body cardBody-Teachers">
                        ...
                        @endif
                        @if ($activity == 0)
                            <form method="POST" action="{{ route('student.storeActivityExtra') }}">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-xs-12">
                                        ...
                                        <input type="text" oninput="validateOnlyNumbersOnInput(this);" id="txtPorcentajeActividad" name="porcentaje" placeholder="Ingrese porcentaje de actividad" class="form-control inputTxt"  value="{{ (7 - $studentInfo[0]->promedio)*10 }}" required>                                                                                           
                                    </div>                                                 
                                </div>		
                                <div class="row mt-1">
                                    <div class="col-12">
