                        ...
                        <div class="col-lg-4 col-xl-6 col-md-6 col-xs-12 my-2">
                            <div class="card" style="height: 220px; max-height: 220px; overflow-y: auto">
                                ...
                                <div class="card-footer text-body-secondary d-flex justify-content-center">
                                    <a href="{{ route('teacherSite.groupInformation',$group->idGrupo) }}" class="btn btn-primary my-1 mx-1" style="background-color: #7386D5;">Información</a>
                                    <a href="{{ route('teacherSite.showEvaluations',$group->idGrupo) }}" class="btn btn-primary my-1" style="background-color: #7386D5;">Actividades/Notas</a>
                                </div>
                            </div>
                        </div>
                    @endforeach 
